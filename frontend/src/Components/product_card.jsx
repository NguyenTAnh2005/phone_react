...
export function ProductCard({ product, baselink, onHandleSeeInfo, max_width = "350px", fs_title = "xl", fs_text = "base", fs_desc = "xs", hover_out = true }) {
    ...
    return (
        <div
            ...
            <Link
                onClick={() => onHandleSeeInfo(product.product_id)}
                to={"/ProductDetails"}
