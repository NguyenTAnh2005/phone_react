    ...
    return (
        <div className="h-screen flex items-center animate__animated animate__fadeIn">
            <form
                ...
                className="w-full text-gray-500 max-w-[350px] rounded-xl p-10 border-gray-300 border-[1px] mx-auto bg-white"
            >
                ...
                <Input
                    ...
                    type="email"
                    label="Email"
                    placeholder="Input your current Email"
                    cls_icon="bi bi-envelope"
                />
                <p className="my-2 text-center text-xs">
                    Input your Email. We'll send new password to your email!
                </p>
            ...
            {showModal && (
                <div
                    ...
                    aria-modal="true"
                >
                    <div className="bg-white rounded-lg flex flex-col relative pt-2.5 p-5 animate__animated animate__zoomIn">
                        <p className="text-mainCL font-semibold mb-2 text-[20px]">Done</p>
                        <p className="text-xs">We have sent new password to your email. Let's go!</p>
                        <i
                            className="bi bi-x absolute right-5 top-2.5 text-[20px] cursor-pointer"
                            onClick={closeModal}
                        ></i>
                    </div>
                </div>
